...
describe('TypedEventEmitter', () => {
    ...
    it('Should resolve correctly when sending event as array', () => __awaiter(void 0, void 0, void 0, function* () {
        const ee = new Emitter_1.TypedEventEmitter();
        const promise = ee.promisifyEvents(['data']);
        ee.emit('data', 12);
        yield expect(promise).resolves.toBe(12);
    ...
    it('Should reject correctly', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        setTimeout(() => ee.emit('error', Error(helpers_for_tests_1.DEFAULT_ERROR_TEXT)), 10);
        yield expect(promise).rejects.toThrow(Error(helpers_for_tests_1.DEFAULT_ERROR_TEXT));
    }));
    it('Should reject correctly when sending event as array', () => __awaiter(void 0, void 0, void 0, function* () {
        const ee = new Emitter_1.TypedEventEmitter();
        const promise = ee.promisifyEvents([], ['error']);
        setTimeout(() => ee.emit('error', Error(helpers_for_tests_1.DEFAULT_ERROR_TEXT)), 10);
        yield expect(promise).rejects.toThrow(Error(helpers_for_tests_1.DEFAULT_ERROR_TEXT));
    ...
    it('Should not throw if rejected after resolving', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        setTimeout(() => ee.emit('error', Error(helpers_for_tests_1.DEFAULT_ERROR_TEXT)), 20);
        yield expect(promise).resolves.toBe(12);
    }));
});
