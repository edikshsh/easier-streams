...
export declare class TransformsHelper extends TransformsHelperBase {
    ...
    filter<TSource>(filterFunction: (chunk: TSource) => boolean, options?: FullTransformOptions<TSource>): import("./transforms/base/simple-transform").SimpleTransform<TSource, TSource>;
...
export declare class AsyncTransformsHelper extends TransformsHelperBase {
    ...
    filter<TSource>(filterFunction: (chunk: TSource) => Promise<boolean>, options?: FullTransformOptions<TSource>): import("./transforms/base/simple-async-transform").SimpleAsyncTransform<TSource, TSource>;
